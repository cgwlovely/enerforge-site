...
| 4 | Contact email set to a real, monitored address | ✅ Pass — `grantchen@heliovulcan.com.au` |
...
2. **Contact email** is set to `grantchen@heliovulcan.com.au` (live `mailto:` links across the site).
